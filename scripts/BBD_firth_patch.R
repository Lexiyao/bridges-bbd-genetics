# =============================================================================
# PATCH for run_firth() — SUPERSEDED / ARCHIVED
#
# The zero-carrier pre-check defined here has been integrated directly into:
#   - BBD_truncating_analysis_v3.R  (run_firth, section 8)
#   - DCIS_LCIS_truncating_analysis.R (run_firth, section 7)
#   - missense_analysis_corrected.R  (already present)
#
# This file is retained for reference only. Do NOT source() it — doing so
# would overwrite the integrated run_firth() in the calling script.
# =============================================================================
